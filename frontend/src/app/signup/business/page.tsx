// frontend/src/app/signup/business/page.tsx
"use client";
...
export default function BusinessSignupPage() {
  ...
  async function handleBusinessSignup(e: React.FormEvent) {
    e.preventDefault();
    ...
    // 2) Call our API to insert into 'business'
    ...
    // 3) Success → redirect to Business Dashboard
